...
urlpatterns = [
    ...
    path('new_question/<int:forum_id>/',
         views.new_question, name='new_question'),
    path('new_answer/<int:question_id>/', views.new_answer, name='new_answer'),
    path('follow-forum/<int:forum_id>/<str:action>/',
         views.follow_forum, name='follow_forum'),
    path('followed_forums/', views.followed_forums, name='followed_forums'),
    path('delete_question/<int:pk>/',
         views.delete_question, name='delete_question'),
    path('delete_answer/<int:pk>/', views.delete_answer, name='delete_answer'),
    path('notifications/', views.notifications, name='notifications'),
    path('toggle-upvote-question/<int:question_id>/',
         views.toggle_upvote_question,
         name='toggle_upvote_question'),
    path('toggle-upvote-answer/<int:answer_id>/',
         views.toggle_upvote_answer,
         name='toggle_upvote_answer'),
