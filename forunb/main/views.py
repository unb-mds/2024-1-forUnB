...
from main.models import Forum, Answer, Question, Notification
...
def forum_detail(request, forum_id):
    ...
    if request.user.is_authenticated:
        is_following = request.user.followed_forums.filter(
            id=forum.id).exists()
...
def questions(request):
    ...
    return render(request, 'main/questions.html', {'questions': ques})
