...
- `pylint` - Commits do tipo pylint indicam a correção de erros de linting, como por exemplo, correção de erros de formatação, identação, espaçamento, entre outros.
